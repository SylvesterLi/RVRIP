    ...
    public class VehicleData
    {
        ...
        public static RailwayVehicleModel DateProcessKernel(RailwayVehicleModel vehicle)
        {
            ...
            if (vehicle.GenTpSelection == 0)
            {
                ...
                int predictFacDate = vehicle.previousDepotDate.Year + 8;
                ...
                switch (vehicle.GenType)
                {
                    case vehicleGenType.Gen70t:
                        ...
                        vehicle.nextFactoryDate = vehicle.previousFactoryDate.AddMonths((6 - n) * 27 + n * 24);
                        ...
                        if (sealEndTime.Year == 2020 || sealEndTime.Year == 2021)
                        {
                            ...
                            vehicle.nextFactoryDate = vehicle.previousFactoryDate.AddMonths((4 - n) * 27 + n * 24).AddMonths(3);
                        }
                        else
                        {
                            //如果不在2020-2011，则按照正常算
                            vehicle.nextFactoryDate = vehicle.previousFactoryDate.AddMonths((4 - n) * 27 + n * 24);
                        }
                    ...
                    case vehicleGenType.Spc70t:
                        ...
                        if (n != 3)
                        {
                            //第一次做加强段修，不增加修程
                            //本次为加强段修，下次做厂修
                            vehicle.nextFactoryDate = vehicle.produceDate.AddMonths(24 * 5);
